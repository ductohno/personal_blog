...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    ...
    credit: {
      ...
      url: 'http://twitter.com'                // (Optional) URL link to the original artwork or artist's page
    }
  },
  toc: {
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/ductohno',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  avatar: 'assets/images/kou.png',  // Relative to the /src directory. Relative to the /public directory if it starts with '/'
  name: 'Ductohno',
  bio: 'Chill guy anyway',
  links: [
    {
      name: 'Facebook',
      ...
      url: 'https://www.facebook.com/profile.php?id=100094295386449',
    },
    {
      name: 'GitHub',
      icon: 'fa6-brands:github',
      url: 'https://github.com/ductohno',
    },
  ],
}
